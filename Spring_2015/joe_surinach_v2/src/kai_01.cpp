...
//----------------------  kai_01 again  -----------------------
//--------------------------------------------------------------
void kai_01::keyPressed(int key){
...
//--------------------------------------------------------------
void kai_01::keyReleased(int key){
    
}

//--------------------------------------------------------------
void kai_01::mouseMoved(int x, int y){
    
}

//--------------------------------------------------------------
void kai_01::mouseDragged(int x, int y, int button){
    if ( drawInterface ) {
...
//--------------------------------------------------------------
void kai_01::mousePressed(int x, int y, int button){
    if ( drawInterface ) {
...
//--------------------------------------------------------------
void kai_01::mouseReleased(int x, int y, int button){
    interf.mouseReleased( x, y );
}

//--------------------------------------------------------------
void kai_01::windowResized(int w, int h){
    
}

//--------------------------------------------------------------
void kai_01::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void kai_01::dragEvent(ofDragInfo dragInfo){
