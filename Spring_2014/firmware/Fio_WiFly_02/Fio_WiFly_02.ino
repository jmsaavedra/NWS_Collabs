...
const char myPassword[] ="1nt3rn3tzz";/* network password */
...
//    wifly.enableDHCP();
    ...
    wifly.setHost("10.0.1.11", 11999);	// Send UDP packets to this server and port
    wifly.setJoin(WIFLY_WLAN_JOIN_AUTO);
    wifly.save(); //saving
    wifly.reboot();
    delay(1000);
    Serial.println("WiFly configured");
